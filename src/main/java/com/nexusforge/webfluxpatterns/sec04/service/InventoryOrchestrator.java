...
import com.nexusforge.webfluxpatterns.sec04.client.InventoryClient;
...
public class InventoryOrchestrator extends Orchestrator {
    ...
    public Predicate<OrchestrationRequestContext> isSuccess() {
        return ctx -> Objects.nonNull(ctx) && Status.SUCCESS.equals(ctx.getInventoryResponse().getStatus());
    }
